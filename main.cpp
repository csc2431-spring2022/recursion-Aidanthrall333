...
size_t MinimumPosition(const int array[], size_t size, size_t min = 0);
void SelectionSort(int array[], size_t size, size_t newSize = 0);
...
size_t MinimumPosition(const int array[], size_t size, size_t min){
    ...
    --size;
    return MinimumPosition(array, size, min);
}
void SelectionSort(int array[], size_t size, size_t newSize){
    if(newSize == size){
        return;
    }
    int smallest = 0;
    ...
    SelectionSort(array, size, newSize + 1);
}
